package main.module1.week3.task1.c;

import main.module1.week4.task3.WrongSensorPackageException;
...
public class Main {
    ...
    public static Integer[][] outputReadings(String readings) throws WrongSensorPackageException {
        if (readings.length() > 512) {
            throw new WrongSensorPackageException("You input String > 512");
        }
